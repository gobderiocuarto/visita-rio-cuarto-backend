<form id="form_event" method="POST" action='{{ url("/admin/events/$event->id")}}' enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-8">
            ...
            <small class="form-text text-muted mt-2">Longitud ideal: 160 caracteres (poner contador)</small>
        </div>
    </div>
    <hr />
    <div class="form-group row">
    ...
    <div class="form-group row">
        <label for="tags_group" class="col-md-3 col-form-label text-md-right">Categorías (*)</label>
        <div class="col-md-8">
            <select multiple class="form-control form-control-xl" id="tags_group" name="tags_group" size="5" required>
                <option value="">Selecciona...</option>
                @foreach ($group_events as $group)
