...
@section('meta_title') {{ config('app.name'). " - Admin :: Crear categorías" }} @endsection
@section('content')
<div class="container">
                ...
                <form id="form_organization_category" method="POST" action="{{ url('/admin/categories/') }}" method="POST">
                    ...
                    <div class="card-body mt-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select id="category_id" name="category_id" class="form-control form-control-xl" data-size="8" required>
