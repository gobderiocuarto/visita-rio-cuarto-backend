...
class EventController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $events_in_group = $user->group->events()
        // ->wherePivot('group_id', $actual_user->group->id)
        ...
        return view('admin.events.index', compact('filter', 'user', 'events', 'event_tags', 'events_in_group'));
